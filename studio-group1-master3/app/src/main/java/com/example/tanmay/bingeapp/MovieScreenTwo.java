...
public class MovieScreenTwo extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener {


    public static final String API_KEY = "AIzaSyAMxhaOYLErwOJGmFIwB7q34KAKCG3Je-g";

    public static final String VIDEO_ID = "D86RtevtfrA";
    ...
    public void viewList() {
        ...
        likeListBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent openLikeList = new Intent(MovieScreenTwo.this, LikeScreen.class);
    ...
    public void like() {
        ...
        likeBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent openAnothermovie = new Intent(MovieScreenTwo.this, MovieScreenThree.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.movie_screentwo);
